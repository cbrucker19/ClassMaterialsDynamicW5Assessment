	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(act == null) {
			...
			try {
				...
				request.setAttribute("month", listToEdit.getCourseStartDate().getMonthValue());
				request.setAttribute("date", listToEdit.getCourseStartDate().getDayOfMonth());
				request.setAttribute("year", listToEdit.getCourseStartDate().getDayOfYear());
